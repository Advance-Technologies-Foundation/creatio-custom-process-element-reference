...
namespace UsrCustomProcessElementApp {
	...
	/// This is the MAIN entry point into the UsrCustomProcessElementApp package.
	/// </summary>
	public sealed class UsrCustomProcessElementApp {

		#region Fields: Private

		private static Lazy<UsrCustomProcessElementApp> _instance = new Lazy<UsrCustomProcessElementApp>(() => new UsrCustomProcessElementApp());
		...
		public static UsrCustomProcessElementApp Instance => _instance.Value;
		...
		private static ServiceProvider Init(){
			...
			serviceCollection.AddTransient<Formatting.IFormatTextHandler, Formatting.FormatTextHandler>();
			serviceCollection.AddTransient<Arithmetic.IAddNumbersHandler, Arithmetic.AddNumbersHandler>();
			serviceCollection.AddTransient<Arithmetic.ISubtractNumbersHandler, Arithmetic.SubtractNumbersHandler>();
			serviceCollection.AddTransient<Arithmetic.IMultiplyNumbersHandler, Arithmetic.MultiplyNumbersHandler>();
			serviceCollection.AddTransient<Arithmetic.IDivideNumbersHandler, Arithmetic.DivideNumbersHandler>();
		...
		/// </summary>
		/// <returns></returns>
		internal UsrCustomProcessElementApp Reset(){
			_serviceProvider.Value?.Dispose();
			_instance = null;
			_instance = new Lazy<UsrCustomProcessElementApp>(() => new UsrCustomProcessElementApp());
		...
		private UsrCustomProcessElementApp() { }
	}
}
